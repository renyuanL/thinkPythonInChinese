`Original html <http://docs.python.org/3.3/library/turtle.html>`__
`Source from <http://docs.python.org/3.3/_sources/library/turtle.txt>`__
...
.. function:: circle(radius, extent=None, steps=None)
              圓(半徑, 延伸= None, 步數= None)
              畫圓(半徑, 延伸= None, 步數= None)
